...
export default function PokemonCard({ pokemon }: PokemonCardProps) {
  return (
    <>
      <div className=" w-94 h-[520px] mx-4 md:mx-auto bg-gradient-to-br from-yellow-100 to-red-100 border-red-600 rounded-xl shadow-[0_8px_8px_0_rgba(0,0,0,0.4)] overflow-hidden text-red-900 font-mono p-4 hover:scale-105 transition-transform opacity-0 animate-fadeIn">
        ...
        <div className="w-full flex justify-end mb-2">
          <PlayCryButton src={pokemon.cries.latest} />
        </div>
      </div>
    </>
  );
